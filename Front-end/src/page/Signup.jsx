    ...
    <div>
      <div className="signup-user w-[500px] h-[500px]  rounded-md border-[1px] absolute translate-x-[-50%] translate-y-[-50%] top-[50%] left-[50%]">
        <div className="signup-container p-[10px]  w-[100%] h-[100%]">
          ...
          <div className="w-[100%] h-[62%] ">
            <form onSubmit={handlesignupsubmit}>
              ...
              <input
                ...
                className="w-full mt-1 bg-[#f3f6fd] h-[46px] leading-[30px] border border-[#DCDDDF] text-[#768492] rounded-sm outline-none p-3 mb-[8px]"
                required
              />
              <label
                htmlFor="Email"
              ...
              <input
                ...
                className="w-full mt-1 bg-[#f3f6fd] h-[46px] leading-[30px] border border-[#DCDDDF] text-[#768492] rounded-sm outline-none p-3 mb-[15px]"
                required
              />
              <button
                type="submit"
          ...
          <p className="mt-[10px] text-center text-[#768492] text-[16px]">
            Already have an Account ?{" "}
            <Link
              to={"/Signin"}
              className="logo-title text-[#1F1C2F] font-bold"
            >
              Sign In
            </Link>
          </p>
